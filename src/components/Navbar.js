                  ...
                  <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    >
                      ...
                      <Dropdown className="nav-item dropdown">
                        ...
                        <Dropdown.Menu>
                          <Dropdown.Item>
                            <Link className="dropdown-item" to="/webinars">Webinars</Link>
                          </Dropdown.Item>
                          
                          <div className="dropdown-divider"></div>
                          
                          <Dropdown.Item>
                            <Link className="dropdown-item" to="/podcast">Podcasts</Link>
                          </Dropdown.Item>
                          
                          <div className="dropdown-divider"></div>
                          
                          <Dropdown.Item>
                            <Link className="dropdown-item" to="/young-professionals">Tech For Young Professionals</Link>
                          </Dropdown.Item>
                          
                          <div className="dropdown-divider"></div>
                          
                          <Dropdown.Item>
                            <Link className="dropdown-item" to="/call-for-action">Call For Action</Link>
                          </Dropdown.Item>
                      ...
                      <Nav.Item className="nav-item">
                          <Link className="nav-link" to="/volunteer"> Volunteer Opportunities</Link>
                      </Nav.Item>

                      <Nav.Item className="nav-item">
                          <Link className="nav-link" to="/volunteer">Harvard in Tech Seattle Buzz</Link> 
                      </Nav.Item>
                      ...
                      <Nav.Item className="nav-item">
                         <Link className="nav-link" to="/webinarsdemo">DemoPage</Link> 
                      </Nav.Item>
