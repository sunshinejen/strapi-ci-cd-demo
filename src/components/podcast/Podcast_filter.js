...
const PodcastFilter = ({setFilterData}) => {

    // Toggle latest podcast view
    const togglePodcastView = (e)=> {
  ...
  return (
    <div className="row align-items-end filter-container">
        <div className="col">
            <h5 className='bts'>Latest Podcasts</h5>
        </div>

        <div className="col d-flex justify-content-end">
            {/* Thumbnail button */}
            <button onClick={togglePodcastView} className="btn" 
